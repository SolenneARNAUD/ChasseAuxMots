...
PARAMS_ZONE_TITRE_RATIO = 8  # HEIGHT // PARAMS_ZONE_TITRE_RATIO (62px)
PARAMS_ZONE_PARAMS_HEIGHT = 360  # Hauteur totale zone paramètres
PARAMS_PARAM_HEIGHT_SMALL = 38  # Hauteur des paramètres 1-3
PARAMS_PARAM_HEIGHT_LARGE = 200  # Hauteur du paramètre bibliothèque
...
PARAMS_INPUT_BOX_WIDTH = 200
PARAMS_INPUT_BOX_HEIGHT = 35
PARAMS_INPUT_BOX_BORDURE = 2
PARAMS_INPUT_BOX_COULEUR_ACTIVE = (100, 150, 255)

# Fenêtre paramètres - Checkbox
PARAMS_CHECKBOX_SIZE = 30
PARAMS_CHECKBOX_OFFSET_X = 40  # Offset par rapport à input_x
PARAMS_CHECKBOX_OFFSET_Y = 3
...
PARAMS_FENETRE_POLICE_TITRE = 48
PARAMS_FENETRE_POLICE_LABEL = 28
PARAMS_FENETRE_POLICE_INPUT = 30
PARAMS_FENETRE_POLICE_BOUTON = 32
