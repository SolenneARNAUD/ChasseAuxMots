...
def sauvegarder_parametres_joueur(pseudo, vitesse_defilement, reset_mots_actif, delai_niveau4=1500, bibliotheque=None):
...
def get_derniers_parametres_joueur(pseudo):
    ...
    Returns:
        dict: {'vitesse_defilement': int, 'reset_mots_actif': bool, 'delai_niveau4': int, 'bibliotheque': list} ou None si pas d'historique
    """
    cle = pseudo.lower()
